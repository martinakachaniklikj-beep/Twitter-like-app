...
export function ChatContainer() {
  ...
  const selectedConversation = selectedConversationId
    ...
    : null;
  const otherParticipant = selectedConversation?.participants?.find((p) => p.userId !== user?.uid);
                        ...
                        <AvatarGroupWrap>
                          <GroupAvatarLeft>
                            <Avatar style={{ width: '100%', height: '100%' }}>
                              <AvatarImage
                                src={
                                  (primaryGroupUser?.avatarUrl as string | undefined) ?? undefined
                                }
                                alt={
                                  primaryGroupUser?.displayName ||
                                  primaryGroupUser?.username ||
                                  'User'
                                }
                              />
                            </Avatar>
                          ...
                          {secondaryGroupUser && (
                            <GroupAvatarRight>
                              <Avatar style={{ width: '100%', height: '100%' }}>
                                <AvatarImage
                                  src={
                                    (secondaryGroupUser.avatarUrl as string | undefined) ??
                                    undefined
                                  }
                                  alt={
      ...
      <ChatArea>
        {selectedConversationId ? (
          <>
            ...
            />
            <ThemeArea $theme={currentTheme} onClickCapture={handleMarkReadInteraction}>
              {hasBlockedParticipantsInGroup &&
                selectedConversation &&
                !dismissedGroupWarnings[selectedConversation.id] && (
                  <BlockedBanner>
              ...
              <MessageList
                ...
                otherAvatarUrl={
                  isDirectBlocked ? undefined : (otherParticipant?.avatarUrl ?? undefined)
                }
                theme={currentTheme}
